...
//INICIALIZAR I | HASTA DONDE LLEGA LA I | LO QUE LE PASA A LA I
for (let i = 0; i < 5; i++) {
  console.log(i);
}

//ARRAY
const alumnos = ["Marta", "Maria", "Kareen", "Carlos", "Sebas", "Cristian"];
...
alumnos.forEach((alumno, i) => console.log(alumno, i));

//OBJETOS
const city = {
  name: "Paris",
  country: "France",
  population: 3795129035,
  region: "Europe",
  alumnos: ["Louise", "Antoine", "Juliette"],
};

for (const iterator in city) {
  console.log(city[iterator]);
}

for (const iterator in city) {
  //-> 5 VUELTAS
  for (const alumno of city.alumnos) {
    //-> 3 VUELTAS
    console.log("DENTRO", alumno);
  }
}

for (let i = 0; i < 3; i++) {
  console.log("ESTOY EN EL BUCLE i", i);
  for (let j = 0; j < 3; j++) {
    console.log("ESTOY EN EL BUCLE j", j);
  }
}
...
for (const objeto of objetos) {
  for (const key in objeto.caracteristicas) {
    if (key === "segundo") {
      console.log(objeto.caracteristicas[key]);
    }
  }
}
...
console.log(mappedPikachu);

for (const type of mappedPikachu.types) {
  console.log(type);
}
...
console.log("SUMA DE SONIDOS", totalCount);
const mediaVolumes = totalCount / users.length;
console.log(mediaVolumes);

//Suma el total de numeros en un array, si el elemento es un string lo que computa es el numero de letras que tiene, y si es un numero el valor del propio numero
const list = ["Gato", 4, 79, "Galleta", "Mesa", 2];
...
console.log("Suma de numeros->", numCount);
console.log("Suma de letras ->", stringCount);
